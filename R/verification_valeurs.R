######################################################
# Vérification d'erreurs non-observé mais possible, comme il s'agit d'erreurs qu'on ne connait pas la valeur voulu
# aucune correction n'est apporté, mais les données émettent un avertissement
